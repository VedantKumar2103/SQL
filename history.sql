...
update participated set damage_amount= 40269 where report_number BETWEEN 25 AND 25000 AND 
participated.regno=20213;
insert into participated values(3, 20213, 6017,34650);
select count(report_number) from accident where acc_date=2002;
select count(accident.report_number) from accident where car.model='Wagon-R';
Select count(regno) as accident_ from participated  where  regno  IN (select regno from car where model='Saltos' OR model="i-10");
